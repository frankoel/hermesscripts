...
class ProjectFunctions:
    ...
    def get_project_id(self, url, token, element_id):
    ...
    def get_project_code(self, url, token, element_code):
        headers = {"Authorization": "Bearer " + token, "Content-type": "application/json"}
    ...
    def update_project(self, url, token, project):
        result_obj = None
        headers = {"Authorization": "Bearer " + token, "Content-type": "application/json"}

        json_to_send = project.to_json()
    ...
    def delete_project(self, url, token, project_id):
        result_obj = None
        headers = {"Authorization": "Bearer " + token, "Content-type": "application/json"}

        result = requests.delete(f"{url}/{project_id}", headers=headers)
